...
/**
OB * s_mod - computes the rest of the division of the second
 * top element of the stack by the top element of the stack
 * @fhead: stack fhead
 * @counter: line_number
OBOBOB * Return: no return
*/
OBOBOBOBOBOBOBOBOBOBvoid s_mod(stack_t **fhead, unsigned int counter)
{
OBOBOBOBOBOBOBOBOBOBOB	stack_t *h;
OBOBOBOBOBOBOBOBOBOBOB	int len = 0, faux;
...
OB		len++;
	...
	if (len < 2)
	{
OB		fprintf(stderr, "L%d: can't mod, stack too short\n", counter);
		fclose(fuse.file);
		free(fuse.fcontent);
		free_fstack(*fhead);
		exit(EXIT_FAILURE);
